                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-navlink href="/pets" :active="request()->is('pets')">Pets</x-navlink>
                                <x-navlink href="/projects" :active="request()->is('projects')">Projects</x-navlink>
                                <x-navlink href="/calendar" :active="request()->is('calendar')">Calendar</x-navlink>
                                <x-navlink href="/reports" :active="request()->is('reports')">Reports</x-navlink>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
