    ...
    <form method="POST" action="{{ route('pets.patch',$pet) }}">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm/6 text-gray-600">Please enter the following information.</p>

                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        <label for="name" class="block text-sm/6 font-medium text-gray-900">Pet´s Name</label>
                        <div class="mt-2">
                            <div
                    ...
                    <div class="sm:col-span-1">
                        <label for="rescue_date" class="block text-sm/6 font-medium text-gray-900">Rescue Date</label>
                        <div class="mt-2">
                            <div
                                class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                    ...
                    <div class="sm:col-span-2">
                        <label for="specie" class="block text-sm/6 font-medium text-gray-900">Specie</label>
                        <div class="mt-2 grid grid-cols-1">
                    ...
                    <div class="sm:col-span-1">
                        <label for="life_stage" class="block text-sm/6 font-medium text-gray-900">Life Stage</label>
                        <div class="mt-2 grid grid-cols-1">
                    ...
                    <div class="sm:col-span-2">
                        <label for="state" class="block text-sm/6 font-medium text-gray-900">State /
                            Province</label>
                        <div class="mt-2">
                    ...
                    <div class="col-span-full">
                        <label for="history" class="block text-sm/6 font-medium text-gray-900">History</label>
                ...
                <fieldset>
                    <div class="mt-6 space-y-6">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm/6">
                                <label for="is_neutered" class="font-medium text-gray-900">Is neutered</label>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div class="flex h-6 shrink-0 items-center">
                            ...
                            <div class="text-sm/6">
                                <label for="has_disability" class="font-medium text-gray-900">has disability</label>
                            </div>
                        </div>
                    </div>
                </fieldset>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="{{ route('pets.index') }}" type="button"
