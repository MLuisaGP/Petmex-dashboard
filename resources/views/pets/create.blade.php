        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        <label for="specie_id" class="block text-sm/6 font-medium text-gray-900">Specie</label>
                        <div class="mt-2 grid grid-cols-1">
                    ...
                    <div class="sm:col-span-1">
                        <label for="lifestage_id" class="block text-sm/6 font-medium text-gray-900">Life Stage</label>
                        <div class="mt-2 grid grid-cols-1">
                            <select id="lifestage_id" name="lifestage_id"
                                class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                <option value="" selected disabled>--Select--</option>
                        ...
                        <div class="flex gap-3">
                            <div class="flex h-6 shrink-0 items-center">
                                <div class="group grid size-4 grid-cols-1">
                                    <input id="is_nature" name="is_nature" type="checkbox" checked
                            ...
                            <div class="text-sm/6">
                                <label for="is_nature" class="font-medium text-gray-900">Is neutered</label>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div class="flex h-6 shrink-0 items-center">
